#!/usr/bin/env python3
"""
Combined Telegram ↔ AnythingLLM Bridge

Combines text message forwarding to AnythingLLM with image file downloading
and AnythingLLM desktop shortcut integration.

Features:
- Text messages: Forward to AnythingLLM API and get responses back
- Images: Download, open locally, and trigger AnythingLLM Screenshot shortcut
...
Usage:
    ...
    python combined_telegram_bridge.py
"""
...
# ---------------------------------------------------------------------------
# Markdown → Telegram HTML (from main branch)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Image handling (from file receiver)
# ---------------------------------------------------------------------------
...
async def main() -> None:
    ...
    try:
        ...
        print(f"⚠️ Failed to register commands: {e}", file=sys.stderr)
    ...
    print("✨ Ready! Send text or images:")
    print("  💬 Text messages → AnythingLLM API responses")
    print("  📷 Images → Download + AnythingLLM desktop shortcut")
    print()
